            ...
            <div class="bg-white rounded-2xl shadow-sm p-6">
                ...
                <div class="space-y-4 text-sm">
                    <div class="flex gap-2 border-b border-gray-200 pb-2">
                        <span class="text-gray-500 w-20 flex-shrink-0">Nama:</span>
                        <span class="text-gray-800 font-medium">{{ $user->name ?? '-' }}</span>
                    </div>
                    <div class="flex gap-2 border-b border-gray-200 pb-2">
                        <span class="text-gray-500 w-20 flex-shrink-0">Email:</span>
                    ...
                    <div class="flex gap-2 border-b border-gray-200 pb-2">
                        <span class="text-gray-500 w-20 flex-shrink-0">Alamat:</span>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-5">
                    ...
                    <form class="w-full sm:w-72" onsubmit="return false;">
                        <div class="flex items-center gap-2 bg-white border border-pink-200 rounded-full px-4 py-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-pink-400 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            @forelse ($transactions as $trx)
                                ...
                                <tr class="border-b border-gray-100 last:border-b-0">
                                    ...
                                    <td class="px-4 py-3 whitespace-nowrap">
                                        <a href="{{ $trx->detail_url ?? '#' }}" class="text-pink-500 font-semibold hover:underline">
                                            Detail
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <a href="?page={{ $page }}"
                               class="w-8 h-8 flex items-center justify-center rounded-full text-sm font-medium transition-colors
                                      {{ $page === $currentPage
                                            ...
                                            : 'border border-pink-300 text-pink-400 hover:bg-pink-50' }}">
                                {{ $page }}
                            </a>
                        @endfor
