            ...
            <div class="bg-pink-100/60 rounded-2xl p-6">
                ...
                <div class="space-y-3 text-sm">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="inline-flex items-center gap-1 bg-green-100 text-green-600 text-xs font-semibold px-3 py-1 rounded-full">
