@php
    $testimonials = [
        ...
        [
            'quote' => 'Cepat, tepat, wangi, rapi, dan ada delivery servicenya. Ada Ajeng Laundry saya ga khawatir kehabisan baju.',
            'name' => 'Ega Nawwarasa H.',
            'status' => 'Pelanggan Baru',
            'image' => '/assets/testimonial-images/ega.jpeg'
        ],
        [
            'quote' => 'Pelayanan nya sangat mantab, karna untuk waktu yg saya tentukan bisa memenuhinya... Cepat dan wangi sekali, terimakasih atas pelayanannya kemaren Ajeng Laundry.',
            'name' => 'Rizky Andika S',
            'status' => 'Pelanggan Baru',
            'image' => '/assets/testimonial-images/rizky.jpeg'
        ],
        [
            'quote' => 'Ajeng Laundry tempat laundry andalan, punya layanan terbaik karena bisa express, harganya terjangkau. Recommended untuk pekerja!',
