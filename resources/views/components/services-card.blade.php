...
<div {{$attributes->merge(['class' => 'bg-ajeng-pink p-6 md:p-8 rounded-[40px] flex flex-col gap-6 text-white w-full font-poppins shadow-sm transition-all duration-300 hover:-translate-y-3 hover:shadow-lg cursor-pointer'])}}>
