<footer class="bg-ajeng-pink pt-16 pb-8 font-poppins text-white w-full">
    <div class="max-w-7xl mx-auto px-6 md:px-8 w-full">
        ...
        <hr class="border-t border-white/30 mt-14 md:mt-20 mb-6">

        <!-- Bagian Bawah: Copyright -->
        <div class="flex justify-start">
            <p class="text-white/80 text-sm md:text-[15px] font-light tracking-wide">
                © 2026 Otaku's Team. All rights reserved
            </p>
        </div>
